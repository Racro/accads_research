    ...
    # body = {
        ...
        },
        {
            ...
            "content":
                ...
                #
                Note: If the substring '...' is present in the provided ad text (ocr output) or the Ad image, it should always be classified as Dark Patterns and Manipulative Design. Also fake or multiple buttons present in the Ad image are problematic as well. 
                ##
